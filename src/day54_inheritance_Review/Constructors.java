...
public class Constructors {
	...
	/*
	 Constructor: special method. belongs to the object.
				 ...
				 12. super class' constructor ( if there isn't default constructor) MUST be called in sub class
				  		(if there is more than one constructor in super class, only one of them needs to be called, see constructor_Practise2)
	...
	//	 example2 obj2 = new example2();   reason: #10 (is not compiling because there is no associated constructor)
