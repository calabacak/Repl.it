...
//	}
	//		variable = expression part ? true function : false function;	
			premium = continuousInsurance.equals("No") ?  2*premium : premium ;
	
	
			System.out.println("What is the highest level of education you have completed?");

			scan.nextLine();// problem solved but try error I dont know the real reason behind:(
			education = scan.nextLine();// maybe problem
