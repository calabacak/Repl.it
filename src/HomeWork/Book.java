...
public class Book {
	 ...
	 * capitalized form(first uppercase - rest lowecase) if argument is empty, it
	...
	public static Boolean isTitleWord(String word) {
		if (word.equalsIgnoreCase("a") || word.equalsIgnoreCase("an") || word.equalsIgnoreCase("the")
				|| word.equalsIgnoreCase("and") || word.equalsIgnoreCase("but") || word.equalsIgnoreCase("for")
				|| word.equalsIgnoreCase("nor") || word.equalsIgnoreCase("or") || word.equalsIgnoreCase("so")
				|| word.equalsIgnoreCase("yet") || word.equalsIgnoreCase("at") || word.equalsIgnoreCase("by")
				|| word.equalsIgnoreCase("in") || word.equalsIgnoreCase("into") || word.equalsIgnoreCase("near")
				|| word.equalsIgnoreCase("of") || word.equalsIgnoreCase("on") || word.equalsIgnoreCase("to")
