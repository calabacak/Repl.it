...
public class HomeWork078_Car_Insurance_Quote {
			...
			if(haveDriverLicense.contentEquals("No")) {
				...
				zipCode = scan.nextInt();
						...
						daysDrivenToWorkOrSchool=scan.nextInt();		
							...
							education=scan.next();
							if(education.contentEquals("PhD")  ||	education.contentEquals("Bachelors")  ||  education.contentEquals("Masters")		) {
							...
							System.out.println("Reference number:"+name.substring(0, 2)+name.substring(name.length()-2)+""+zipCode+education.replace(" ", ""));
